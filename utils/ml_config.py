...
SEG_DICT = {
    "PSPNetR50_water_vapor": {"weights": "mm_segmentation/checkpoints/iter_52000_83_59.pth",
    ...
    "PSPNetR101_AES": {"weights": "mm_segmentation/checkpoints/pspnet_r101-d8_aes_iter_79000.pth",
                       "config": "mm_segmentation/configs/pspnet_r101-d8_aes.py",
    ...
    "UperNetR101_AES": {"weights": "mm_segmentation/checkpoints/upernet_r101_aes_iter_80000.pth",
                        "config": "mm_segmentation/configs/upernet_r101_aes.py",
                        "classes": ['background', 'reactor_sq', 'reactor', 'engine_room', 'pipe', 'switchgear', 'pump',
                                    'cooltower', 'ct_vent_circle', 'ct_vent_sq', 'ct_active', 'discharge', 'ISFSI',
                                    'tank', 'sea', 'parking', 'splash_pool'],
                        "palette": [
    ...
    "SegFormerMiTB5_AES": {"weights": "mm_segmentation/checkpoints/segformer_mit_b5_160k_aes_iter_150000.pth",
                           "config": "mm_segmentation/configs/segformer_mit_b5_160k_aes.py",
                           "classes": ['background', 'reactor_sq', 'reactor', 'engine_room', 'pipe', 'switchgear',
                                       'pump',
                                       'cooltower', 'ct_vent_circle', 'ct_vent_sq', 'ct_active', 'discharge', 'ISFSI',
                                       'tank', 'sea', 'parking', 'splash_pool'],
                           "palette": [
    ...
    "DeepLab_v3Plus_R101_512_AES": {"weights": "mm_segmentation/checkpoints/deeplab_r101_512_aes_iter_80000.pth",
                                    "config": "mm_segmentation/configs/deeplab_r101_512_aes.py",
                                    "classes": ['background', 'reactor_sq', 'reactor', 'engine_room', 'pipe',
                                                'switchgear', 'pump',
                                                'cooltower', 'ct_vent_circle', 'ct_vent_sq', 'ct_active', 'discharge',
                                                'ISFSI',
                                                'tank', 'sea', 'parking', 'splash_pool'],
                                    "palette": [
                                        [0, 0, 0],  # фон
...
SAM_DICT = {
    ...
    'FastSAM': {'weights': 'sam_models/FastSAM-x.pt', 'config': "",
                "type": "FastSAM"},
    'EdgeSAM': {'weights': 'sam_models/edge_sam_3x.pth', 'config': "",
                "type": "EdgeSAM"},
    # 'RepViTSAM': {'weights': 'sam_models/edge_sam_3x.pth', 'config': "",
    #             "type": "EdgeSAM"},
}
